<x-guest-layout>
    <div class="text-center">
        <h1 class="text-6xl font-bold text-accent mb-4">403</h1>
        <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-2">{{ __('messages.access_denied') }}</h2>
        <p class="text-gray-600 dark:text-gray-400 mb-8">
            {{ __('messages.sorry_you_do_not_have_permission_to_access_this_pa') }}</p>
