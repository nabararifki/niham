<x-guest-layout>
    <div class="text-center">
        ...
        <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-2">{{ __('messages.page_not_found') }}
        </h2>
        <p class="text-gray-600 dark:text-gray-400 mb-8">
            {{ __('messages.sorry_the_page_you_are_looking_for_could_not_be_fo') }}</p>
